...
export class F04003Component implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    const baseUrl = 'http://192.168.0.62:9082/EmployeeSet/gmOption';
    ...
    const roleUrl = 'http://192.168.0.62:9082/EmployeeSet/getRole';
...
//============================================================
  ...
  getEmployeeList() {
    ...
    const baseUrl = 'http://192.168.0.62:9082/EmployeeSet/search';
    ...
    .subscribe(data => {
      ...
      if (data.rspBody.size == 0) { this.dialog.open(F04003confirmComponent, { data: { msgStr: '查無資料' } }); }
    });
